...
from src.core.memory.short_term import ShortTermMemory, Message
from src.core.tools.base import BaseTool, ToolResult
from src.core.tools import CalculatorTool
...
class TestShortTermMemory:
    ...
    def test_get_context(self):
        ...
        memory.clear()  # Clear any leftover messages from previous tests
        memory.add_message("user", "Hello")
...
class TestBaseTool:
    """Tests for BaseTool - using CalculatorTool as concrete implementation."""
