...
class FileOperationTool(BaseTool):
    ...
    def _write_file(self, path: str, content: str, overwrite: bool = False) -> ToolResult:
    ...
    def _list_directory(self, path: str = ".", pattern: str = "*") -> ToolResult:
    ...
    def _delete_path(self, path: str) -> ToolResult:
    ...
    def _read_json(self, path: str) -> ToolResult:
        """Read JSON file."""
        try:
            file_path = self._resolve_path(path)
            with open(file_path, 'r', encoding='utf-8') as f:
    ...
    def _write_json(self, path: str, data: Dict, indent: int = 2) -> ToolResult:
